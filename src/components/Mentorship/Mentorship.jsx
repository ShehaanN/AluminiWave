            ...
            <div className="bg-white rounded-lg shadow p-6 min-h-screen">
              <div className="grid grid-cols-4  gap-6">
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500 mb-4">
                    <i className="fas fa-briefcase mr-2"></i>15 years experience
                  </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500 mb-4">
                    <i className="fas fa-briefcase mr-2"></i>10 years experience
                  </div>
                  <div className="space-y-2 mb-4">
                    <span className="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm mr-2">
                      Product Strategy
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500 mb-4">
                    <i className="fas fa-briefcase mr-2"></i>12 years experience
                  </div>
                  <div className="space-y-2 mb-4">
                    <span className="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm mr-2">
                      Digital Marketing
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500 mb-4">
                    <i className="fas fa-briefcase mr-2"></i>8 years experience
                  </div>
                  <div className="space-y-2 mb-4">
                    <span className="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm mr-2">
                      Cloud Computing
              ...
              <div className="flex flex-row justify-between">
                ...
                <Card className="w-[650px] p-8 border-none mt-4 shadow-none">
                  <CardHeader>
                    <CardTitle className="text-2xl">Session Request</CardTitle>
                    {/* <CardDescription>
